...
/*
  ...
  |
  | ------------------------------------------------------------------- */
define('BASE', 'http://localhost/recoelho');
//$config['img_path'] = /admin/upload/trabalhos';
$config['img_path'] = '/admin/upload'; // Relative to domain name
$config['upload_path'] = BASE . $config['img_path']; // Physical path. [Usually works fine like this]
